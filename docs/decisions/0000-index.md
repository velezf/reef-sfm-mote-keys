...
| [0025](0025-camera-nadir-leveling.md) | camera-nadir UP leveling for collinear markers (T1 ADR-0025) | Accepted | 6 |
| [0026](0026-t1-aoi-transect-placement.md) | T1 AOI: 10×1 m transect placement — XY centre, angle, Z window (original) | **Superseded by 0028** | 6 |
| [0027](0027-t1-dsm-resolution-1cm.md) | T1 DSM at 1 cm resolution (ADR-0027) | Accepted | 6 |
| [0028](0028-t1-aoi-z-window-corrected.md) | T1 AOI: corrected Z window, surface-median-anchored (supersedes 0026 Z window) | Accepted | 6 |
| [0029](0029-fullarea-ortho-pointcloud-direct.md) | Full-area ortho built PointCloudData-direct — ESM Step 15 deviation; buildDem hangs on 487M-pt cloud in Metashape 2.3.1 | Accepted | 6 |
